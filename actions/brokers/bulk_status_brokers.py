...
def main():
    ...
    print("\n" + "="*40)
    print("   BLOQUEIO/LIBERAÇÃO EM MASSA - CORRETORES (V2)")
    print("="*40)
    print(" [1] ATIVAR todos os corretores da lista")
    print(" [2] INATIVAR todos os corretores da lista")
    print(" [0] Cancelar")
    print("="*40)
    ...
    print(f">>> {action_label} {len(user_ids)} corretores...")
    ...
    try:
        ...
        if resp.status_code in [200, 201]:
            print(f"\n[OK] SUCESSO! Todos os {len(user_ids)} corretores foram processados.")
