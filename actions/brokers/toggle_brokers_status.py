...
def main():
    ...
    print("\n" + "="*30)
    print("   MENU DE STATUS CORRETORES")
    print("="*30)
    print(" [1] Ativar corretores (apenas os inativos)")
    print(" [2] Inativar corretores (apenas os ativos)")
    print(" [0] Cancelar")
    print("="*30)
    ...
    total = len(rows)
    print(f">>> Processando {total} corretores para {action_label}...\n")
    ...
    for i, row in enumerate(rows, 1):
        ...
        print(f"[{i}/{total}] Corretor: {name} (ID: {user_id})")
